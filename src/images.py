...
class ImageProcesser:
    ...
    def __init__(self, output_directory=None, class_label=None, n_job=1, target_type="label", 
                 fixed_size=None, save_to_disk=False, save_format=None):        
        self.output_directory = output_directory
        if target_type not in ("label", "bounding_box", "pose", "segement_class", "segment_object"):
            raise ValueError('''label type should be in one of ("label", "pose", "bounding_box", 
                             "segement_class", "segment_object").''')
